...
export default (props) => {
	...
	axiosResponse = props.usersData.length === 0 ? axios.get('https://social-network.samuraijs.com/api/1.0/users').then(response =>	props.getUsersCB(response.data.items)) : null;
